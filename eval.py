...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str, default='cuda',
                    help='cpu or cuda')
    parser.add_argument('--topk1', type=int, default='10', help='frist top k')
    parser.add_argument('--topk2', type=int, default='10', help='tok k')
    parser.add_argument('--image_k', type=int, default='50', help='image_k')
    parser.add_argument('--sim', type=float, default='0.8', help='word similarity')
    parser.add_argument('--apply', type=int, default='15', help='word apply count')
    parser.add_argument('--dbs_type',type=int, default='1', help='1 : SDBS, 2 : Hamming DBS')
    ...
    if opt.only_lang_eval == 1 or (opt.force and os.path.isfile(pred_fn)):
    ...
    print("image folder : ",opt.image_folder)
